"""
Pure OpenAI Agents SDK implementation of the simple agentic RAG example.
This shows what the target developer experience should be with our TensorZero integration.
"""
...
Remember: Your primary value is in providing accurate, well-sourced information from Wikipedia rather than generated responses from your training data. When in doubt, search, think, and verify. Always use the `answer_question` tool to return your final answer."""
    ...
    return Agent(
        ...
        model="gpt-4o-mini",  # Using OpenAI directly
...
async def main():
    """Main function to test the RAG agent."""

    print("🚀 Starting Pure OpenAI Agents SDK - Simple Agentic RAG")
    print("=" * 60)
