...
//!
//! The goal is to let you `cargo rm nalgebra` without touching the algorithmic
//! code.  If you later need more features (row/col slices, transposition, etc.)
//! extend this file or replace it with a crate like `ndarray`.
//!
//! ## Use
//! ```rust
//! mod simple_matrix;              // or `use crate::simple_matrix as sm;`
//! use simple_matrix::Matrix;      // then drop‑in‑replace DMatrix<_> with Matrix<_>
//! ```
//!
