...
LegacyDatapoint = deprecated("Use Datapoint instead")(Datapoint)
ChatDatapoint = deprecated("Use DatapointChat instead")(DatapointChat)
JsonDatapoint = deprecated("Use DatapointJson instead")(DatapointJson)
