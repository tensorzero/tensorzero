...
@dataclass(kw_only=True)
class InferenceResponseToolCallInternal:
    """
...
@dataclass(kw_only=True)
class InferenceResponseToolCall(InferenceResponseToolCallInternal):
    type: Literal["tool_call"] = "tool_call"


@dataclass(kw_only=True)
class MessageContentToolResult:
    """
...
@dataclass(kw_only=True)
class MessageContentUnknown(Unknown):
...
@dataclass(kw_only=True)
class MessageContentInputFileUrlFile(UrlFile):
    """
    A file for an inference or a datapoint.
    """
...
@dataclass(kw_only=True)
class MessageContentInputFileBase64(Base64File):
    """
    A file for an inference or a datapoint.
    """
...
@dataclass(kw_only=True)
class MessageContentThought(Thought):
    type: Literal["thought"] = "thought"


ContentBlockChatOutput = MessageContentText | InferenceResponseToolCall | MessageContentThought | MessageContentUnknown
...
@dataclass(kw_only=True)
class MessageContentInputFileObjectStoragePointer(ObjectStoragePointer):
    """
    A file for an inference or a datapoint.
    """
...
@dataclass(kw_only=True)
class MessageContentInputFileObjectStorageFile(ObjectStorageFile):
    """
    A file for an inference or a datapoint.
    """
...
@dataclass(kw_only=True)
class MessageContentInputFileObjectStorageError(ObjectStorageError):
    """
    A file for an inference or a datapoint.
    """
