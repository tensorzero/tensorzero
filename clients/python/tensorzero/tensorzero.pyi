...
class TensorZeroGateway(BaseTensorZeroGateway):
    ...
    def inference(
        ...
        *,
        ...
        :param namespace: The namespace for experimentation. If provided, namespace-specific experimentation
                          configs will be used if available. Stored as a `tensorzero::namespace` tag.
                          Must match the pattern [a-z][a-z0-9_]* (lowercase letters, digits, and underscores, starting with a letter).
