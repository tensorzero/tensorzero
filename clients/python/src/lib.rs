...
use tensorzero_core::{
    ...
    inference::types::pyo3_helpers::{
        deserialize_from_pyobj, deserialize_from_stored_sample, deserialize_optimization_config,
        serialize_to_dict, tensorzero_core_error, tensorzero_core_error_class,
        tensorzero_error_class, JSON_DUMPS, JSON_LOADS,
    },
    optimization::{
...
use tensorzero_rust::{
    ...
    InferenceStream, Input, LaunchOptimizationParams, ListDatapointsRequest, ListInferencesParams,
