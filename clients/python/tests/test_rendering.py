    ...
    rendered_samples = embedded_sync_client.experimental_render_samples(
        stored_samples=[
            StoredInferenceChat(
                ...
                input=StoredInput(
                    ...
                    messages=[
                        ...
                        StoredInputMessage(
                            role="assistant",
                            content=[
                                MessageContentText(type="text", text="Hello world"),
                                MessageContentToolResult(
                                    type="tool_result",
                                    id="123",
                                    name="test_tool",
                                ...
                                MessageContentUnknown(type="unknown", data=[{"woo": "hoo"}]),
                            ],
                        ),
                        StoredInputMessage(
                            role="user",
                ...
                dispreferred_outputs=[[MessageContentText(text="goodbye")]],
                tags={},
            ...
            StoredInferenceJson(
                ...
                input=StoredInput(
                    ...
                    messages=[
                        StoredInputMessage(
                            role="user",
                            content=[MessageContentTemplate(name="user", arguments={"country": "Japan"})],
                        ),
                    ],
                ),
                ...
                StoredInferenceChat(
                    ...
                    input=StoredInput(
                        ...
                        messages=[
                            StoredInputMessage(
                                role="user",
                                content=[MessageContentText(type="text", text="bar")],
                            )
                        ],
                    ),
                    output=[MessageContentText(text="Hello world")],
