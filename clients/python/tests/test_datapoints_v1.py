    ...
    requests = [
        CreateDatapointRequestChat(
            ...
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text="First message")])],
            ),
            output=[MessageContentText(text="First response")],
        ),
        CreateDatapointRequestChat(
            function_name="basic_test",
            input=Input(
                system={"assistant_name": "TestBot"},
                messages=[InputMessage(role="user", content=[MessageContentText(text="Second message")])],
            ),
            output=[MessageContentText(text="Second response")],
        ),
        CreateDatapointRequestJson(
            ...
            input=Input(
                ...
                messages=[
                    InputMessage(
                        role="user", content=[MessageContentTemplate(name="user", arguments={"country": "Canada"})]
                    )
                ],
            ),
    ...
    requests = [
        CreateDatapointRequestChat(
            ...
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text="Async message")])],
            ),
        ),
        CreateDatapointRequestJson(
            function_name="json_success",
            input=Input(
                ...
                messages=[
                    InputMessage(
                        role="user", content=[MessageContentTemplate(name="user", arguments={"country": "Mexico"})]
                    )
                ],
            ),
        ),
    ...
    requests = [
        CreateDatapointRequestChat(
            ...
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text="msg1")])],
            ),
        ),
        CreateDatapointRequestChat(
            function_name="basic_test",
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text="msg2")])],
            ),
        ),
        CreateDatapointRequestJson(
            function_name="json_success",
            input=Input(
                ...
                messages=[
                    InputMessage(
                        role="user", content=[MessageContentTemplate(name="user", arguments={"country": "Brazil"})]
                    )
                ],
            ),
        ),
    ...
    requests = [
        CreateDatapointRequestChat(
            ...
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text="test1")])],
            ),
        ),
        CreateDatapointRequestChat(
            function_name="basic_test",
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text="test2")])],
            ),
        ),
    ]
    ...
    requests = [
        CreateDatapointRequestChat(
            ...
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text="original")])],
            ),
            name="original_name",
        ),
    ]
    ...
    requests = [
        CreateDatapointRequestJson(
            ...
            input=Input(
                ...
                messages=[
                    InputMessage(
                        role="user", content=[MessageContentTemplate(name="user", arguments={"country": "France"})]
                    )
                ],
            ),
            name="initial",
    ...
    requests = [
        CreateDatapointRequestChat(
            ...
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text=f"message {i}")])],
            ),
        )
        for i in range(5)
    ]
        ...
        CreateDatapointRequestJson(
            ...
            input=Input(
                ...
                messages=[
                    InputMessage(
                        role="user",
                        content=[MessageContentTemplate(name="user", arguments={"country": f"Country{i}"})],
                    )
                ],
            ),
        )
    ...
    requests = [
        CreateDatapointRequestChat(
            ...
            input=Input(
                ...
                messages=[InputMessage(role="user", content=[MessageContentText(text=f"data {i}")])],
            ),
        )
        for i in range(10)
    ]
