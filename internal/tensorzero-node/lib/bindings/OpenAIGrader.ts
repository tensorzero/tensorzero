...
export type OpenAIGrader = { "type": "string_check", name: string, 
/**
 ...
 */
reference: string, } | { "type": "text_similarity", name: string, 
/**
 ...
 */
reference: string, } | { "type": "score_model", name: string, 
/**
 ...
 */
range: [number, number] | null, } | { "type": "label_model", name: string, 
/**
 ...
 */
input: Array<OpenAIModelGraderInput>, } | { "type": "python", name: string, 
/**
 ...
 */
image_tag: string | null, } | { "type": "multi", 
/**
 ...
 */
graders: { [key in string]?: OpenAIGrader }, name: string, };
