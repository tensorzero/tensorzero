...
<<<<<<< HEAD
export type UninitializedOptimizerInfo = { "type": "dicl" } & UninitializedDiclOptimizationConfig | { "type": "openai_sft" } & UninitializedOpenAISFTConfig | { "type": "fireworks_sft" } & UninitializedFireworksSFTConfig | { "type": "gcp_vertex_gemini_sft" } & UninitializedGCPVertexGeminiSFTConfig | { "type": "together_sft" } & UninitializedTogetherSFTConfig;
=======
