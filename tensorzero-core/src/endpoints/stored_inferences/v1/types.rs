...
pub struct GetInferenceBoundsParams {
    ...
    /// Maximum number of inferences to consider (for pagination support).
    pub limit: Option<u32>,

    /// Filter to inferences before this ID (exclusive, for pagination).
    pub before: Option<Uuid>,

    /// Filter to inferences after this ID (exclusive, for pagination).
