...
// =============================================================================
// Provider Tools Tests (web_search, bash)
// =============================================================================
...
/// Test Anthropic provider tools with web_search (non-streaming)
...
"#;
    ...
    println!("Anthropic web_search response: {response:?}");
...
/// Test Anthropic provider tools with web_search (streaming)
#[tokio::test(flavor = "multi_thread")]
...
"#;
    ...
    let response = result.unwrap();
    println!("Anthropic web_search streaming response: {response:?}");
