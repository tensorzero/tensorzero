...
[models."claude-sonnet-4-5-20250929-thinking-aws-bedrock"]
routing = ["aws_bedrock"]

[models."claude-sonnet-4-5-20250929-thinking-aws-bedrock".providers.aws_bedrock]
type = "aws_bedrock"
...
extra_body = [
    { pointer = "/generationConfig/thinkingConfig/thinkingBudget", value = 128 },
    { pointer = "/generationConfig/thinkingConfig/includeThoughts", value = true },
]

[models."gemini-3-flash"]
routing = ["google_ai_studio_gemini"]

[models."gemini-3-flash".providers.google_ai_studio_gemini]
type = "google_ai_studio_gemini"
...
[models."qwen3-next-80b-a3b-instruct-together"]
routing = ["together"]

[models."qwen3-next-80b-a3b-instruct-together".providers.together]
type = "together"
...
[models."qwen3-next-80b-a3b-instruct-together-dynamic"]
routing = ["together"]

[models."qwen3-next-80b-a3b-instruct-together-dynamic".providers.together]
type = "together"
model_name = "Qwen/Qwen3-Next-80B-A3B-Instruct"
...
[models."grok_4_1_fast_non_reasoning-dynamic"]
routing = ["xai"]

[models."grok_4_1_fast_non_reasoning-dynamic".providers.xai]
type = "xai"
model_name = "grok-4-1-fast-non-reasoning"
...
# Echo model: returns the input text (for exact_match testing)
[models.echo]
routing = ["echo"]

[models.echo.providers.echo]
type = "dummy"
model_name = "echo"

# Empty model: always returns empty string (for exact_match testing)
[models.empty]
routing = ["empty"]

[models.empty.providers.empty]
type = "dummy"
model_name = "empty"
...
[models.loopback-dummy]
routing = ["loopback"]

[models.loopback-dummy.providers.loopback]
type = "openai"
api_base = "http://localhost:3000/openai/v1/"
api_key_location = "none"
model_name = "tensorzero::model_name::dummy::good"
