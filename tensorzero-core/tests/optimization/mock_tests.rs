...
embedded_workflow_test_case!(gcp_vertex_gemini_sft, common::gcp_vertex_gemini_sft::GCPVertexGeminiSFTTestCase());
http_workflow_test_case!(gcp_vertex_gemini_sft, common::gcp_vertex_gemini_sft::GCPVertexGeminiSFTTestCase());
