...
mod tests {
    ...
    async fn test_infer_model_request_errors() {
        ...
        assert!(logs_contain(
            r#"ERROR test_infer_model_request_errors:infer_model_request{model_name=dummy_chat_model}:infer{provider_name="error"}: gateway::error: Error sending request to Dummy provider."#
        ));
    }
    ...
    async fn test_infer_model_request_errors_stream() {
        ...
        assert!(logs_contain(
            r#"ERROR test_infer_model_request_errors_stream:infer_model_request_stream{model_name=dummy_chat_model}:infer_stream{provider_name="error"}: gateway::error: Error sending request to Dummy provider."#
        ));
    }
}
