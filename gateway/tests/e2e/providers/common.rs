...
macro_rules! generate_provider_tests {
    ($func:ident) => {
        ...
        use $crate::providers::common::test_shorthand_inference_request_with_provider;
        ...
        async fn test_shorthand_inference_request() {
            ...
            for provider in providers {
                test_shorthand_inference_request_with_provider(provider).await;
            }
        }
...
pub async fn test_shorthand_inference_request_with_provider(provider: E2ETestProvider) {
    let episode_id = Uuid::now_v7();
    let tag_value = Uuid::now_v7().to_string();
