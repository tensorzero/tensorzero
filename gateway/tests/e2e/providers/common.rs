...
macro_rules! generate_provider_tests {
    ($func:ident) => {
        use $crate::providers::common::test_dynamic_tool_use_tool_choice_auto_used_inference_request_with_provider;
        use $crate::providers::common::test_dynamic_tool_use_tool_choice_auto_used_streaming_inference_request_with_provider;
        ...
        #[tokio::test]
        async fn test_dynamic_tool_use_tool_choice_auto_used_inference_request() {
            let providers = $func().await.dynamic_tool_use_inference;
            for provider in providers {
                test_dynamic_tool_use_tool_choice_auto_used_inference_request_with_provider(provider).await;
            }
        }

        #[tokio::test]
        async fn test_dynamic_tool_use_tool_choice_auto_used_streaming_inference_request() {
            let providers = $func().await.dynamic_tool_use_inference;
            for provider in providers {
                test_dynamic_tool_use_tool_choice_auto_used_streaming_inference_request_with_provider(provider).await;
            }
        }
...
pub async fn test_dynamic_tool_use_tool_choice_auto_used_inference_request_with_provider(
    provider: E2ETestProvider,
) {
    let episode_id = Uuid::now_v7();
...
pub async fn test_dynamic_tool_use_tool_choice_auto_used_streaming_inference_request_with_provider(
    provider: E2ETestProvider,
) {
    let episode_id = Uuid::now_v7();
