 ...
 */
discard_unknown_chunks: boolean, } & ({ "type": "anthropic", model_name: string, api_base: string | null, api_key_location: string | null, beta_structured_outputs?: boolean, provider_tools: Array<JsonValue>, } | { "type": "aws_bedrock", model_id: string, region: string | null, 
/**
