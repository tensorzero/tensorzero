 ...
 */
precision_targets?: { [key in string]: number }, } & ({ evaluation_config: EvaluationConfig, evaluation_name: string, function_config: EvaluationFunctionConfig, } | { function_name: string, evaluator_names: Array<string>, } | { evaluation_name: string, });
