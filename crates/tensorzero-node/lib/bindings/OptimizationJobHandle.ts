...
export type OptimizationJobHandle = { "type": "dicl" } & DiclOptimizationJobHandle | { "type": "openai_sft" } & OpenAISFTJobHandle | { "type": "openai_rft" } & OpenAIRFTJobHandle | { "type": "fireworks_sft" } & FireworksSFTJobHandle | { "type": "gcp_vertex_gemini_sft" } & GCPVertexGeminiSFTJobHandle | { "type": "gepa" } & GEPAJobHandle | { "type": "together_sft" } & TogetherSFTJobHandle;
