 ...
 */
export type JsonEvaluationResultRow = { inference_id: string, episode_id: string, datapoint_id: string, evaluation_run_id: string, 
/**
 ...
 */
reference_output?: JsonInferenceOutput, dataset_name: string, 
/**
