 ...
 */
export type GCPVertexGeminiSFTConfig = { model: string, learning_rate_multiplier?: number, adapter_size?: number, n_epochs?: number, export_last_checkpoint_only?: boolean, seed?: bigint, tuned_model_display_name?: string, };
