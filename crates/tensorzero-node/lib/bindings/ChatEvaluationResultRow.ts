 ...
 */
export type ChatEvaluationResultRow = { inference_id: string, episode_id: string, datapoint_id: string, evaluation_run_id: string, 
/**
 ...
 */
reference_output?: Array<ContentBlockChatOutput>, dataset_name: string, 
/**
