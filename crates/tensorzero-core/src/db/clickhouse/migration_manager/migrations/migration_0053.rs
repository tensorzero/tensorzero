...
/// that feed it:
/// - `VariantStatisticsModelView`: triggers on `ModelInference`, JOINs `InferenceById` for
///   function_name/variant_name, aggregates token/cost metrics.
...
impl Migration for Migration0053<'_> {
    ...
    async fn apply(&self, clean_start: bool) -> Result<(), Error> {
        ...
        // JOINs InferenceById to resolve function_name/variant_name from the inference_id.
        self.clickhouse
            .run_query_synchronous_no_params(format!(
                r"
