//! Sequential (synchronous) GEPA optimizer implementation.
//!
//! This module contains the `Optimizer` and `JobHandle` trait implementations
//! for running GEPA optimization synchronously within a single process.
...
use super::analyze::analyze_inferences;
use super::evaluate::{
    EvaluateVariantParams, VariantName, VariantScores, create_evaluation_dataset, evaluate_variant,
};
use super::mutate::mutate_variant;
use super::pareto::{Candidate, ParetoFrontier, is_improvement};
use super::validate::{get_uninitialized_variant_configs, validate_examples, validate_gepa_config};
