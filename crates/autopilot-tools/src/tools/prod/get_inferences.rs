        ...
        let schema = serde_json::json!({
            ...
            "properties": {
                ...
                "output_source": {
                    ...
                    "default": "inference",
                    "description": "Source for the output field: 'none' (no output, metadata only), 'inference' (original inference output), or 'demonstration' (demonstration feedback if available)."
                }
            },
            "required": ["ids"],
