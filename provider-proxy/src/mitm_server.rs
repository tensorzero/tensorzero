//! Code is based on [http-mitm-proxy's lib.rs](https://github.com/hatoo/http-mitm-proxy/blob/7c8c3bde77173af6385d5d0ffaea6105498df1ff/src/lib.rs) (MIT-licensed)
