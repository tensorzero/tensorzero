...
<Tip>
**Next steps?**
The [Quick Start](/quickstart) shows it's easy to set up an LLM application with TensorZero.
If you want to dive deeper, the [Tutorial](/guides/advanced/tutorial) teaches how to build a simple chatbot, an email copilot, a weather RAG system, and a structured data extraction pipeline.
...
<details>
<summary>Why is the TensorZero Gateway a proxy instead of a library?</summary>
...
In [Benchmarks](/guides/advanced/benchmarks), it achieves sub-millisecond P99 latency overhead under extreme load.
...
<details>
<summary>How is the TensorZero Gateway so fast?</summary>
...
In [Benchmarks](/guides/advanced/benchmarks), LiteLLM @ 100 QPS adds 25-100x+ more latency than the TensorZero Gateway @ 10,000 QPS.

</details>

<details>
<summary>Why did you choose ClickHouse as TensorZero's analytics database?</summary>
...
<details>
<summary>Who is behind TensorZero?</summary>
...
<details>
<summary>How is TensorZero licensed?</summary>
...
<details>
<summary>How does TensorZero make money?</summary>
