...
In [Benchmarks](/docs/gateway/benchmarks/), it achieves sub-millisecond P99 latency overhead under extreme load.
...
In [Benchmarks](/docs/gateway/benchmarks/), LiteLLM @ 100 QPS adds 25-100x+ more latency than the TensorZero Gateway @ 10,000 QPS.
