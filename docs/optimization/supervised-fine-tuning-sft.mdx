...
You can find a [complete runnable example](https://github.com/tensorzero/tensorzero/tree/main/examples/docs/guides/optimization/supervised-fine-tuning-sft/) of this guide on GitHub.
...
After deploying the [TensorZero Gateway](/deployment/tensorzero-gateway) with [Postgres](/deployment/postgres), [build a dataset](/gateway/api-reference/datasets-datapoints) of good examples for the `extract_entities` function you configured.
