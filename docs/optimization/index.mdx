...
The analyzer examines consecutive requests for prefix overlap, estimates cost savings, and recommends where to place cache breakpoints.

See the [Prompt Caching Analysis Guide](/optimization/prompt-caching-analysis) to learn more.
