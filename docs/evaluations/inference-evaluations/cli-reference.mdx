...
The dataset should be stored in your database.
...
This flag specifies the name of the function to evaluate.
The function should be defined in your TensorZero configuration file.
...
This flag specifies which evaluators to run, as a comma-separated list.
The evaluators should be defined under the function's configuration in your TensorZero configuration file.
