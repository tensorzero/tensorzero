---
title: Log feedback
sidebarTitle: Log feedback (e.g. metrics)
...
Feedback captures the downstream outcomes of your LLM application, and drive the [experimentation](/docs/gateway/tutorial/#experimentation) and [optimization](/docs/recipes/) workflows in TensorZero.
