---
title: Run automated A/B tests
description: Learn how to use experimentation to test and iterate on your LLM applications with confidence.
---

You can set up automated A/B tests with the TensorZero Gateway to automatically distribute inference requests to the best performing variants (prompts, models, etc.) of your system.
...
Let's set up an automated A/B test with TensorZero.

<Tip>

You can find a [complete runnable example](https://github.com/tensorzero/tensorzero/tree/main/examples/docs/guides/experimentation/run-automated-ab-tests) of this guide on GitHub.
...
![Experimentation in the TensorZero UI](/experimentation/run-automated-ab-tests.gif)
