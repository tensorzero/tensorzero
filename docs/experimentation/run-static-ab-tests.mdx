...
Each [TensorZero function](/gateway/configure-functions-and-variants) can have multiple variants, and the gateway will sample between them based on their weights.
