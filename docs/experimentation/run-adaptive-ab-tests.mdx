...
You can configure different experimentation configs per namespace (e.g. per tenant or platform).
See [Namespaces](/experimentation/namespaces) for more details.
