...
# HELP request_count Requests handled by TensorZero
# TYPE request_count counter
request_count{endpoint="inference",function_name="tensorzero::default",model_name="gpt-4o-mini-2024-07-18"} 1
request_count{endpoint="feedback",metric_name="draft_accepted"} 10

# HELP inference_count Inferences performed by TensorZero
# TYPE inference_count counter
inference_count{endpoint="inference",function_name="tensorzero::default",model_name="gpt-4o-mini-2024-07-18"} 1
