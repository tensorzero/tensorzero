...
tensorzero_inference_latency_overhead_seconds{function_name="my_function",variant_name="my_variant",quantile="0.5"} 0.002
tensorzero_inference_latency_overhead_seconds{function_name="my_function",variant_name="my_variant",quantile="0.9"} 0.005
tensorzero_inference_latency_overhead_seconds{function_name="my_function",variant_name="my_variant",quantile="0.99"} 0.01
```
