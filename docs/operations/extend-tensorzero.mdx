...
TensorZero stores all its data on your own database.

You can query this data directly by running SQL queries against your database.
If you're feeling particularly adventurous, you can also write to database directly (though you should be careful when upgrading your TensorZero deployment to account for any database migrations).
