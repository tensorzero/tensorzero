...
See [Configuration Reference](/gateway/configuration-reference/) and [Inference API Reference](/gateway/api-reference/inference-openai-compatible) for more details.
...
See [Inference API Reference](/gateway/api-reference/inference-openai-compatible) for more details.
