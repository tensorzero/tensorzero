...
When using the TensorZero Python SDK, you can pass custom attributes using the `otlp_traces_extra_attributes` parameter:
...
When using the TensorZero Python SDK, you can pass custom resources using the `otlp_traces_extra_resources` parameter:
