...
This is useful for scenarios like trying a dynamic credential first with a fallback to a static environment variable, providing redundancy across multiple credential sources, or gracefully handling credential rotation.
