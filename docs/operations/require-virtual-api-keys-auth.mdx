---
title: Require virtual API keys (auth)
description: Learn how to require virtual API keys to authenticate your TensorZero Gateway clients.
---

You can create virtual (custom) API keys for the TensorZero Gateway.
This way, your clients don't need access to model provider credentials, making it easier to manage access and security.

This page shows how to:

- Create virtual (custom) API keys for the TensorZero Gateway
- Require clients to use these API keys for requests
- Manage API keys in the TensorZero UI

## Set up and enforce virtual API keys
