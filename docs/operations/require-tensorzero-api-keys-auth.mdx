---
title: Require TensorZero API keys (auth)
description: Learn how to require TensorZero API keys to authenticate your TensorZero Gateway clients.
---

You can create TensorZero API keys to authenticate your TensorZero Gateway clients.
