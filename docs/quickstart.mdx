---
title: Quick Start — From 0 to Observability & Fine-Tuning
description: Get up and running with TensorZero in 5 minutes.
---

This Quick Start guide shows how we'd upgrade an OpenAI wrapper to a minimal TensorZero deployment with built-in observability and fine-tuning capabilities &mdash; in just 5 minutes.
