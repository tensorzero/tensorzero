...
- **Automated Prompt Engineering.**
  ...
  GEPA iteratively refines your prompt templates based on an inference evaluation, and MIPROv2 jointly optimizes instructions and in-context examples in prompts.<br />
  [→ Guide: Optimize your prompts with GEPA](/optimization/gepa) <br />
