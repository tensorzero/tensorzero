...
- **Unified Inference API.**
  ...
  [→ TensorZero Gateway Quick Start](/quickstart/)
...
- **Automatic Fallbacks for Higher Reliability.**
  ...
  [→ Retries & Fallbacks with TensorZero](/guides/inference/call-any-llm-provider/)
...
- **Built-in Evaluations.**
  ...
  [→ TensorZero Evaluations Overview](/guides/evaluation/evaluate-individual-inferences/)
...
- **Built-in Experimentation (A/B Testing).**
  ...
  [→ Experimentation (A/B Testing) with TensorZero](/guides/experimentation/compare-variants-ab-testing/)
...
- **Built-in Inference-Time Optimizations.**
  ...
  [→ Inference-Time Optimizations with TensorZero](/guides/optimization/overview/)
...
- **Optimization Recipes.**
  ...
  [→ Optimization Recipes with TensorZero](/guides/optimization/overview/)
...
- **Batch Inference.**
  ...
  [→ Batch Inference with TensorZero](/guides/inference/call-any-llm-provider/)
...
- **Inference Caching.**
  ...
  [→ Inference Caching with TensorZero](/guides/inference/call-any-llm-provider/)
...
- **Schemas, Templates, GitOps.**
  ...
  [→ Prompt Templates & Schemas with TensorZero](/configuration-reference/)
...
Learn more about using [OpenRouter as a model provider](/guides/inference/model-providers/openrouter/).