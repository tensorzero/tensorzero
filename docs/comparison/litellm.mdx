...
- **Multimodal Inference.**
  ...
  [→ Multimodal Inference with TensorZero](/guides/inference/call-any-llm-provider/)
...
- **High Performance.**
  ...
  [→ Performance Benchmarks: TensorZero vs. LiteLLM](/guides/advanced/benchmarks/)
...
Learn more about using [OpenAI-compatible endpoints](/guides/inference/model-providers/openai-compatible/).