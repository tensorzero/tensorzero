...
2. **Collect a structured inference dataset.**
   Imagine down the road you want to [fine-tune a model](/optimization/supervised-fine-tuning-sft) using your historical data.
...
Historical observability data stored in your database still uses the legacy format.
