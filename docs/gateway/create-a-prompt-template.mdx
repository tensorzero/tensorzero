...
1. **Decouple prompts from application code.**
   As you iterate on your prompts over time (or [A/B test different prompts](/experimentation/run-automated-ab-tests)), you'll be able to manage them in a centralized way without making changes to the application code.
