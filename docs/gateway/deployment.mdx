...
See the [optimizing latency and throughput](/gateway/optimize-latency-and-throughput/) guide to learn how to configure the gateway for high-performance deployments.
