...
- A **function** represents a task in your application (e.g. "write a product description" or "answer a customer question").
- A **variant** is a specific way to accomplish that task: a choice of model, prompt, inference parameters, etc.
