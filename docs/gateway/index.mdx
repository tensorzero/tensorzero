...
- **Structured Inferences.**
  ...
  Structured inference data is later used for powerful optimization workflows (e.g. swapping historical prompts before fine-tuning).
...
- **Built-in Observability.**
  ...
  Everything is stored in your database for real-time, scalable, and developer-friendly analytics.
  [Optimization workflows](/optimization/) leverage this dataset to optimize your LLMs.
