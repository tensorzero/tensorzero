...
The gateway translates the OpenAI request parameters and calls the desired model providers.

### Request

The OpenAI-compatible inference endpoint accepts standard OpenAI request parameters along with TensorZero-specific extensions.
...
```python frame="code" title="POST /openai/v1/chat/completions" mark="draft_email"
...
```bash frame="code" title="POST /openai/v1/chat/completions" mark="draft_email"
...
```json frame="code" title="POST /openai/v1/chat/completions"
{
...
```python frame="code" title="POST /openai/v1/chat/completions" mark="weather_bot"
from openai import AsyncOpenAI
...
```bash frame="code" title="POST /openai/v1/chat/completions" mark="weather_bot"
curl -X POST http://localhost:3000/openai/v1/chat/completions \
  -H "Content-Type: application/json" \
  -d '{
    "model": "tensorzero::function_name::weather_bot",
...
```json frame="code" title="POST /openai/v1/chat/completions" mark="get_temperature"
{
  "id": "00000000-0000-0000-0000-000000000000",
  "episode_id": "11111111-1111-1111-1111-111111111111",
...
```python frame="code" title="POST /openai/v1/chat/completions" mark="extract_email"
from openai import AsyncOpenAI
...
```bash frame="code" title="POST /openai/v1/chat/completions" mark="extract_email"
curl -X POST http://localhost:3000/openai/v1/chat/completions \
  -H "Content-Type: application/json" \
  -d '{
    "model": "tensorzero::function_name::extract_email",
...
```json frame="code" title="POST /openai/v1/chat/completions" mark="email"
{
  "id": "00000000-0000-0000-0000-000000000000",
  "episode_id": "11111111-1111-1111-1111-111111111111",
