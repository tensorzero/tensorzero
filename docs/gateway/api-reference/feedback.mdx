...
```toml title="tensorzero.toml" mark="boolean" mark="draft_accepted" mark="inference"
# ...
...
```toml title="tensorzero.toml" mark="float" mark="user_rating" mark="episode" mark="float"
# ...
[metrics.user_rating]
type = "float"
level = "episode"
