...
```toml mark="boolean" mark="draft_accepted" mark="inference" title="tensorzero.toml"
# ...
...
```toml mark="float" mark="user_rating" mark="episode" mark="float" title="tensorzero.toml"
# ...
[metrics.user_rating]
type = "float"
level = "episode"
