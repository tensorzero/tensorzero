...
Custom span attributes to attach to OTLP trace exports for this specific inference request.
Values must be valid JSON strings or booleans.

See [Export OpenTelemetry traces](/operations/export-opentelemetry-traces#send-custom-opentelemetry-attributes) for more details and examples.
...
Custom resource attributes to attach to OTLP trace exports for this specific inference request.

See [Export OpenTelemetry traces](/operations/export-opentelemetry-traces#send-custom-opentelemetry-resources) for more details and examples.
