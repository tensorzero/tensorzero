...
```toml mark="draft_email" title="tensorzero.toml"
# ...
...
```toml "weather_bot" /"(get_temperature)"/ /(get_temperature)]/ title="tensorzero.toml"
# ...
...
```toml "weather_bot" title="tensorzero.toml"
# ...
...
```toml mark="draft_email" mark="temperature" mark="chat_completion" title="tensorzero.toml"
# ...
[functions.draft_email]
type = "chat"
# ...
...
```toml mark="extract_email" title="tensorzero.toml"
# ...
