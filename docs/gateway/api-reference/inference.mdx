...
In streaming mode, the response is an <a href="https://developer.mozilla.org/en-US/Web/API/Server-sent_events/Using_server-sent_events#event_stream_format" target="_blank">SSE</a> stream of JSON messages, followed by a final `[DONE]` message.
