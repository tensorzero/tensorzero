...
| [Groq](/docs/gateway/guides/providers/groq/)                                         | `GROQ_API_KEY`                |
...
| [OpenRouter](/docs/gateway/guides/providers/openrouter/)                             | `OPENROUTER_API_KEY`          |
...
See [Configuration Reference](/docs/gateway/configuration-reference/) (e.g. `api_key_location`) for more information on the different ways to configure credentials for each provider.
...
See [Retries & Fallbacks](/docs/gateway/guides/retries-fallbacks/) for more information on how to configure retries and fallbacks.
