...
When using an OpenAI SDK, the client will handle the SSE stream under the hood and return a stream of chunk objects.

See [API Reference](/gateway/api-reference/inference-openai-compatible/) for more details.
