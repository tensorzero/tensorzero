...
See [Integrations](/gateway/integrations/) for a list of supported models.
...
volumes: # Mount our tensorzero.toml file into the container - ./config:/app/config:ro
...
ports: - "9000:9000" # API port - "9001:9001" # Console port
environment:
