...
You can use them alongside other features like [experimentation](/experimentation/run-adaptive-ab-tests), [metrics & feedback](/gateway/guides/metrics-feedback/), and [tool use (function calling)](/gateway/tutorial/#tools).
