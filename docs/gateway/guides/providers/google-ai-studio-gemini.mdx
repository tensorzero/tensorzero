---
title: Getting Started with Google AI Studio (Gemini API)
sidebarTitle: Google AI Studio
description: "Learn how to use TensorZero with Google AI Studio LLMs: open-source gateway, observability, optimization, evaluations, and experimentation."
---
...
See the [list of models available on Google AI Studio (Gemini API)](https://ai.google.dev/gemini-api/models/gemini).
