...
See the [list of models available on Anthropic](https://docs.anthropic.com/en/about-claude/models).
...
See [Extending TensorZero](/gateway/guides/extending-tensorzero/) for information about Anthropic Computer Use and other beta features.
