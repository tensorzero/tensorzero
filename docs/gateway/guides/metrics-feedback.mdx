...
We'll use the inference response's ID to link the two.

<Note>

Feedback requires the [TensorZero Python SDK](/gateway/clients/python) or the [HTTP API](/gateway/api-reference/feedback).
Inference can use any OpenAI SDK.
