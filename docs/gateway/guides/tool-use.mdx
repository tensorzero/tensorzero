...
See [Integrations](/docs/gateway/integrations/) for a list of supported model providers.
...
<LinkCard
  ...
  href="/docs/gateway/api-reference/inference/"
/>

<LinkCard
  title="API Reference: Inference (OpenAI-Compatible)"
  href="/docs/gateway/api-reference/inference-openai-compatible/"
/>
