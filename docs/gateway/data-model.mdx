...
| `finish_reason`       | Nullable(Enum8('stop', 'length', 'tool_call', 'content_filter', 'unknown', 'stop_sequence'))    | Reason the model stopped generating                        |
| `snapshot_hash`       |                                        Nullable(UInt256)                                        | Configuration snapshot hash for data provenance            |
...
| `finish_reason`   | Nullable(Enum8('stop', 'length', 'tool_call', 'content_filter', 'unknown', 'stop_sequence'))    | Cached finish reason                                 |
