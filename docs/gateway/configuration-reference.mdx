...
Sets a global override for the Anthropic Messages API base URL that will be applied to shorthand (`anthropic::model`) references. The URL should include the full endpoint path, such as `https://example.com/v1/messages`.
