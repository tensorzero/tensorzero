...
See [the API reference](/gateway/api-reference/inference/#credentials) and [Credential Management](/operations/manage-credentials/#credential-fallbacks) for more details.
...
# credential_location = "path_from_env::GCP_CREDENTIALS_PATH"
...
# credential_location = { default = "dynamic::gcp_credentials_path", fallback = "env::GCP_CREDENTIALS_PATH" }
# ...
```
