...
Defines the location of the API key for the Azure provider.
...
Defines the deployment ID of the Azure deployment.

See <a href="https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models" target="_blank">Azure AI's documentation</a> for the list of available models.
...
Defines the endpoint of the Azure deployment (protocol and hostname).
