...
```toml mark="openai" mark="azure" title="tensorzero.toml"
[models.gpt-4o]
# ...
...
```toml mark="gpt-4o" mark="openai" mark="azure" title="tensorzero.toml"
[models.gpt-4o]
# ...
routing = ["openai", "azure"]
# ...
...
```toml mark="run-python" title="tensorzero.toml"
...
```toml mark="query-database" title="tensorzero.toml"
...
```toml mark="get-temperature" title="tensorzero.toml"
