...
# api_key_location = { default = "dynamic::azure_api_key", fallback = "env::AZURE_OPENAI_API_KEY" }
# ...
```
...
- **Type:** string or object
- **Required:** no (default: `env::AZURE_API_KEY` with fallback to `env::AZURE_OPENAI_API_KEY` - deprecated)
