...
# or with fallback:
# region = { default = "dynamic::bedrock-region", fallback = "env::AWS_REGION" }
# ...
```
...
# or with fallback:
# endpoint_url = { default = "dynamic::bedrock-endpoint", fallback = "env::BEDROCK_ENDPOINT_URL" }
```
...
# or: region = "sdk"  # auto-detect using AWS SDK
# or with fallback:
# region = { default = "dynamic::sagemaker-region", fallback = "env::AWS_REGION" }
# ...
```
...
# or with fallback:
# endpoint_url = { default = "dynamic::sagemaker-endpoint", fallback = "env::SAGEMAKER_ENDPOINT_URL" }
```
