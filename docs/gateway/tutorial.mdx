...
For a comprehensive guide to configuring models and providers, see [Configure models and providers](/gateway/configure-models-and-providers).
...
To learn more about variant configuration options, see [Configure functions and variants](/gateway/configure-functions-and-variants).
...
You can also [run adaptive A/B tests](/experimentation/run-adaptive-ab-tests) with TensorZero to optimize variant weights based on production metrics.
