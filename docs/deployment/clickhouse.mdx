...
If you're planning to use the gateway without observability, you don't need to ClickHouse.

You can also [deploy Postgres](/deployment/postgres) as backend for observability.
