...
For [custom rate limits](/operations/enforce-custom-rate-limits), you can use either Postgres or [Valkey](/deployment/valkey). Valkey is recommended for high-throughput deployments.
