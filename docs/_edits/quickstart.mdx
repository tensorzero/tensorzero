---
title: Quickstart — From 0 to Observability & Fine-Tuning
...
<div class="flex gap-4">
  <div>
    <img
      src="quick-start-observability-function.png"
  ...
  <div>
    <img
      src="quick-start-observability-inference.png"
...
<img
  src="quick-start-observability"
  alt="TensorZero UI Fine-Tuning Screenshot"
/>

<Tip>

We can also send [metrics & feedback](/docs/gateway/guides/metrics-feedback/) to the TensorZero Gateway.
...
We strongly encourage you to check out the guides on [metrics & feedback](/docs/gateway/guides/metrics-feedback/) and [prompt templates & schemas](/docs/gateway/guides/prompt-templates-schemas/).
