---
title: Export OTLP (OpenTelemetry data)
sidebarTitle: Export OTLP (OpenTelemetry)
...
<center>
  <small>
    Example: Screenshot of a TensorZero Gateway inference request trace in
    Jaeger
  </small>
</center>
...
See [Auxiliary Endpoints](/docs/gateway/api-reference/auxiliary-endpoints/) for more details.
