...
- **Inference Caching.**
  ...
  [→ Inference Caching with TensorZero](/guides/gateway/call-any-llm-provider)
...
- **Separation of Concerns: Application Engineering vs. LLM Optimization.**
  ...
  [→ Prompt Templates & Schemas with TensorZero](/guides/gateway/call-any-llm-provider)<br />
...
- **Performance & Scalability.**
  ...
  [→ TensorZero Gateway Benchmarks](/guides/advanced/benchmarks)
...
- **Language and Platform Agnostic.**
  ...
  [→ TensorZero Gateway API Reference](/api-reference/introduction)
...
- **Batch Inference.**
  ...
  [→ Batch Inference with TensorZero](/guides/gateway/call-any-llm-provider)
...
- **Credential Management.**
  ...
  [→ Credential Management with TensorZero](/guides/deployment/gateway)
...
- **Automatic Fallbacks for Higher Reliability.**
  ...
  [→ Retries & Fallbacks with TensorZero](/guides/gateway/call-any-llm-provider)
