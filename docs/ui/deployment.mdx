...
See the [TensorZero Gateway Deployment Guide](/gateway/deployment/) for more details on how to deploy the gateway and ClickHouse database.
...
See the [Deploy ClickHouse](/deployment/deploy-clickhouse) guide for more details.
