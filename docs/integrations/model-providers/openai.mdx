...
Additionally, you can set the model in the inference request to use a specific OpenAI model, without having to configure a function and variant in TensorZero.
...
You can also set the model in inference requests:
