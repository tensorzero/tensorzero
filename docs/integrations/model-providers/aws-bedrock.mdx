...
You can specify `tensorzero::extra_body` in the [configuration](/gateway/configuration-reference) (as `extra_body`) or at [inference time](/gateway/api-reference/inference-openai-compatible).
