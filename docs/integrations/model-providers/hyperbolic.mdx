---
title: Getting Started with Hyperbolic
sidebarTitle: Hyperbolic
description: "Learn how to use TensorZero with Hyperbolic LLMs: open-source gateway, observability, optimization, evaluations, and experimentation."
---
...
Additionally, you can set the model in the inference request to use a specific Hyperbolic model, without having to configure a function and variant in TensorZero.
