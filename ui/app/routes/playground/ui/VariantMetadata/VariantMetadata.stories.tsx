...
const meta: Meta<typeof VariantMetadata> = {
  title: "Playground/VariantMetadata",
  component: VariantMetadata,
  parameters: {
    layout: "padded",
  },
  argTypes: {
    onOpenVariant: { action: "opened variant" },
  },
  decorators: [
    (Story) => (
...
export default meta;
type Story = StoryObj<typeof VariantMetadata>;
...
const chainOfThoughtVariant: VariantConfig = {
...
// Minimal variant (most values null/default)
const minimalVariant: VariantConfig = {
  type: "chat_completion",
  weight: null,
  model: "gpt-3.5-turbo",
  system_template: null,
