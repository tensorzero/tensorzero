...
function EventStreamError() {
  ...
  return (
    <div className="border-border mt-8 flex min-h-0 flex-1 flex-col items-center justify-center gap-4 overflow-y-auto rounded-lg border p-4">
      <div className="text-center">
        <p className="font-medium text-red-600">Error loading events</p>
