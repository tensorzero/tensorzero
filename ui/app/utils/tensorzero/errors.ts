...
export class TensorZeroServerError extends Error {
  ...
  static AllVariantsFailed =
    class AllVariantsFailed extends TensorZeroServerError {
  ...
  static ExtraBodyReplacement =
    class ExtraBodyReplacement extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static BadCredentialsPreInference =
    class BadCredentialsPreInference extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static BatchInputValidation =
    class BatchInputValidation extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static ClickHouseConnection =
    class ClickHouseConnection extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
        this.name = "ClickHouseConnectionError";
      }
    };
  static ClickHouseDeserialization =
    class ClickHouseDeserialization extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
        this.name = "ClickHouseDeserializationError";
      }
    };
  static ClickHouseMigration =
    class ClickHouseMigration extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
  ...
  static ObjectStoreUnconfigured =
    class ObjectStoreUnconfigured extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static DatapointNotFound =
    class DatapointNotFound extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.NOT_FOUND });
      }
    };
  ...
  static DynamicJsonSchema =
    class DynamicJsonSchema extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static InvalidInferenceTarget =
    class InvalidInferenceTarget extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static ObjectStoreWrite =
    class ObjectStoreWrite extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  ...
  static InferenceNotFound =
    class InferenceNotFound extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.NOT_FOUND });
      }
    };
  ...
  static InferenceTimeout =
    class InferenceTimeout extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.REQUEST_TIMEOUT });
      }
    };
  static ModelProviderTimeout =
    class ModelProviderTimeout extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.REQUEST_TIMEOUT });
      }
    };
  ...
  static InvalidClientMode =
    class InvalidClientMode extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static InvalidTensorzeroUuid =
    class InvalidTensorzeroUuid extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static UnsupportedContentBlockType =
    class UnsupportedContentBlockType extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static InvalidBatchParams =
    class InvalidBatchParams extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static InvalidCandidate =
    class InvalidCandidate extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static InvalidDiclConfig =
    class InvalidDiclConfig extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static InvalidDatasetName =
    class InvalidDatasetName extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static InvalidWorkflowEvaluationRun =
    class InvalidWorkflowEvaluationRun extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static InvalidFunctionVariants =
    class InvalidFunctionVariants extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static InvalidInferenceOutputSource =
    class InvalidInferenceOutputSource extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static InvalidMetricName =
    class InvalidMetricName extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static InvalidModelProvider =
    class InvalidModelProvider extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static InvalidOpenAICompatibleRequest =
    class InvalidOpenAICompatibleRequest extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static InvalidProviderConfig =
    class InvalidProviderConfig extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  ...
  static InvalidTemplatePath =
    class InvalidTemplatePath extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  ...
  static InvalidVariantForOptimization =
    class InvalidVariantForOptimization extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  ...
  static JsonSchemaValidation =
    class JsonSchemaValidation extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static MiniJinjaEnvironment =
    class MiniJinjaEnvironment extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static MiniJinjaTemplate =
    class MiniJinjaTemplate extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static MiniJinjaTemplateMissing =
    class MiniJinjaTemplateMissing extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static MiniJinjaTemplateRender =
    class MiniJinjaTemplateRender extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static MissingBatchInferenceResponse =
    class MissingBatchInferenceResponse extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static MissingFunctionInVariants =
    class MissingFunctionInVariants extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static MissingFileExtension =
    class MissingFileExtension extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static ModelProvidersExhausted =
    class ModelProvidersExhausted extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  ...
  static OutputValidation =
    class OutputValidation extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static ProviderNotFound =
    class ProviderNotFound extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.NOT_FOUND });
      }
    };
  ...
  static UnknownCandidate =
    class UnknownCandidate extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  ...
  static UnsupportedFileExtension =
    class UnsupportedFileExtension extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static UnsupportedModelProviderForBatchInference =
    class UnsupportedModelProviderForBatchInference extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static UnsupportedVariantForBatchInference =
    class UnsupportedVariantForBatchInference extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.BAD_REQUEST });
      }
    };
  static UnsupportedVariantForStreamingInference =
    class UnsupportedVariantForStreamingInference extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
  static UnsupportedVariantForFunctionType =
    class UnsupportedVariantForFunctionType extends TensorZeroServerError {
      constructor(message: string) {
        super(message, { status: HttpStatusCode.INTERNAL_SERVER_ERROR });
      }
    };
