  ...
  buildEvent(
    {
      ...
      payload: {
        ...
        tool_call_event_id: "0a1b2c3d-4e5f-4a6b-8c7d-3456789012c3",
        tool_call_name: "fetch_context",
        tool_call_arguments: { query: "session data" },
      },
    },
    1,
  ),
  ...
  buildEvent(
    {
      ...
      payload: {
        ...
        tool_call_arguments: { table: "sessions" },
      },
    },
    5,
  ),
  ...
  buildEvent(
    {
      ...
      payload: {
        type: "tool_result",
        tool_call_event_id: "8c9d0e1f-2a3b-4c4d-9e5f-1234567890e1",
        tool_call_name: "analyze_data",
        tool_call_arguments: { dataset: "large_dataset" },
        outcome: {
          type: "success",
