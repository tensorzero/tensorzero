...
const largeJSONOutputFixture = {
  answer: "Paris",
  source: "https://en.wikipedia.org/wiki/Paris",
  trivia:
    "Paris is often referred to as 'The City of Light.' This nickname originated during the Age of Enlightenment. At that time, Paris was a major center for education. It was also a hub for new ideas. The city's intellectual and cultural influence was significant.",
  details: {
    population: "2,148,271",
    area: "105.4 km²",
    description:
      "Paris is the capital and most populous city of France. It is known for its art, gastronomy, and culture.",
    landmarks: [
      {
        name: "Eiffel Tower",
        description:
          "An iron lattice tower located on the Champ de Mars, named after the engineer Gustave Eiffel.",
        height: "324 meters",
      },
      {
        name: "Louvre Museum",
...
const largeJSONOutputSchemaFixture = {
  type: "object",
  properties: {
    answer: { type: "string" },
        ...
        landmarks: {
          ...
          items: {
            ...
            properties: {
              ...
              visitorsPerYear: { type: "string", optional: true },
            },
            required: ["name", "description"],
          },
        },
      },
      required: ["population", "area", "description", "landmarks"],
    },
    history: {
      type: "object",
      properties: {
      ...
      required: ["founded", "significantEvents"],
    },
  },
  required: ["answer", "source", "details", "history", "trivia"],
};

export const JSONFunctionLargeJSON: Story = {
  args: {
    output: {
      raw: JSON.stringify(largeJSONOutputFixture),
      parsed: largeJSONOutputFixture,
      schema: largeJSONOutputSchemaFixture,
    },
  },
};
