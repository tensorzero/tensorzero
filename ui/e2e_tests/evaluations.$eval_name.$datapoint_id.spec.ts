...
test("should show the evaluation result page", async ({ page }) => {
  await page.goto(
    "/evaluations/entity_extraction/01939a16-b258-71e1-a467-183001c1952c?eval_run_ids=0195c501-8e6b-76f2-aa2c-d7d379fe22a5,0195aef8-36bf-7c02-b8a2-40d78049a4a0",
  );
