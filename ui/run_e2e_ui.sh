...
TENSORZERO_CLICKHOUSE_URL="http://chuser:chpassword@localhost:8123/tensorzero_e2e_tests" TENSORZERO_UI_CONFIG_PATH="../tensorzero-core/tests/e2e/tensorzero.toml" pnpm run dev
