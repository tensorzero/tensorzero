...
clickhouse-client --host $CLICKHOUSE_HOST --user chuser --password chpassword --database tensorzero_ui_fixtures --query "INSERT INTO TagInference FORMAT JSONEachRow" < tag_inference_examples.jsonl
