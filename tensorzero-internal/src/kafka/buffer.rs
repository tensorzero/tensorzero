use super::cloudevents::{CloudEvent, ObservabilityEntry};
...
impl MessageBuffer {
    ...
    pub async fn add(&self, entry: ObservabilityEntry) -> Result<Option<Vec<ObservabilityEntry>>, String> {
...
pub async fn start_flush_task<F>(
