// Note: These tests have been temporarily disabled as moderation is now handled
// through the unified model system with endpoint capabilities.
// The separate moderation_models configuration has been removed.
// TODO: Update these tests to use the new unified model system
...
//     // Test disabled - needs update for unified model system
// }
