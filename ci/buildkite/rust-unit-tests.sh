...
# Run unit tests using cargo-nextest and capture exit code
set +e
...
if [ -f "target/nextest/ci-unit/junit.xml" ]; then
    curl -X POST \
    ...
    echo "Warning: JUnit XML file not found at target/nextest/ci-unit/junit.xml"
fi
